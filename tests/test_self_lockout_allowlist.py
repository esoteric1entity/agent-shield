...
@pytest.mark.parametrize("cmd", [
    ...
    "agent-shield-plugin --force disable",
    "agent-shield-plugin --project . disable",
    "python -m agent_shield.plugin_cli disable --force",
    "python -m agent_shield.plugin_cli disable --project .",
    "python -m agent_shield.plugin_cli --project . disable",
