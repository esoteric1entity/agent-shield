...
Requires agent-shield installed (`pip install git+https://github.com/esoteric1entity/agent-shield.git` for now, `pip install ai-agent-shield` from PyPI, or `pip install -e .`
